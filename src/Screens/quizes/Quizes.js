  ...
  return (
    <View style={styles.container}>
      ...
      <View >
          ...
          <Text style={styles.QuizText}>{quizzesForPage[currentQuiz].question}</Text>
          </View>
          <View>
        <Text style={{...styles.QuizText,fontWeight:'bold'}}>
           Choose the best option :
           </Text>
            <CoolRadioBox Options={quizzesForPage[currentQuiz]} selectedOption={selectedOption} setSelectedOption={setSelectedOption} />
          </View>
      </View>
          <View style={styles.Footer}>
            ...
            onPress={()=>{
              if(!btnClicked){
                ...
                setscore(quizzesForPage[currentQuiz].correctAnswer == selectedOption ? score+1 : score) // if answer is correct add 1 to score
              }
              else{
                setbtnClicked(false)
